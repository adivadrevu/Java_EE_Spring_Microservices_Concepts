package com.SpringBoot.MultiDBProj.config1;
...
basePackages="com.SpringBoot.MultiDBProj.repo.cx")
public class DB1Config {
	...
	public LocalContainerEntityManagerFactoryBean db1EntityManager(EntityManagerFactoryBuilder emfb) {
		...
		// we are inputting all the properties for MySQL, which we would input in application.properties file
		...
		return emfb.dataSource(db1DataSource())
				.packages("com.SpringBoot.MultiDBProj.model.customer")
